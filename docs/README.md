...
| Document | Read it when |
| --- | --- |
| [Model setup](MODELS.md) | You are choosing, downloading or swapping the GGUF model. |
| [Preparing the pendrive](PENDRIVE.md) | You have a blank drive and need it formatted and loaded. |
| [Building a release](BUILD.md) | You want to build the drive from source, in one command or step by step. |
| [Development setup](DEVELOPMENT.md) | You are changing the code. |
...
| Document | Read it when |
| --- | --- |
| [Architecture](ARCHITECTURE.md) | You want the design decisions and the reasoning behind them. |
| [Testing](TESTING.md) | You want the measurements and the test matrix. |
